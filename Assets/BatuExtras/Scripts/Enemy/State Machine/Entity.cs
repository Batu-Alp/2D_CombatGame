...
public class Entity : MonoBehaviour
{
    ...
    [SerializeField]
    private Transform ledgeCheck; // Check for ledge or wall
    [SerializeField]
    ...
    public virtual void Start()
    {
        ...
        // Every entity will have own instance
    }
    ...
    public virtual void Damage_Enemy(AttackDetails attackDetails)
    {
        lastDamageTime = Time.time;
        currentHealth -= attackDetails.damageAmount;
        currentStunResistance -= attackDetails.stuntDamageAmount;
